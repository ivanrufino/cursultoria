    ...
    <table align="center" width="600" border="0" cellpadding="0" cellspacing="0" style="margin:15px auto;">
      ...
      <tr>
        <td colspan="2" bgcolor="#FFFFFF">
            ...
            <p>Estamos enviando este aviso para informar que não localizamos o pagamento da sua fatura vencida em <b><?=dateFormat($VENCIMENTO, "d/m/Y")?></b>. Caso tenha qualquer dúvida a respeito dos valores ou queira negociar a sua fatura, por gentileza, nos contate. Os serviços prestados poderão sofrer interrupção a qualquer momento.</p>
            
            <p><b>É muito importante que você entre em contato com nosso departamento financeiro para agendar seu pagamento ainda hoje.</b></p>        
            <p>
