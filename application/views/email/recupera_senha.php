...
<body style="margin:0px; padding:0px; background:#eee;">	
    ...
    <table align="center" id="recursos" width="600" border="0" cellpadding="0" cellspacing="0" style="margin:15px auto;">
      <tr>
        ...
        <td align="right">
        	<h2 style="float:right; text-align:right; margin:25px 0px 5px 10px; color:#666; font-family:Arial, Helvetica, sans-serif; font-size:26px; font-weight:normal; letter-spacing:-1px;">Recuperação de Senha</h2>
        </td>
      </tr>
      <tr>
        <td colspan="2" bgcolor="#FFFFFF">
            ...
            <p>Olá! <b><?=$RAZAO_NOME?></b>,</p>
            
            <p>Este e-mail possui todos os dados e configurações que você precisa saber para utilizar sua conta na <?=$this->users->nome_chave()?></p>
