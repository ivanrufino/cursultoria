...
<body style="margin:0px; padding:0px; background:#eee;">	
    ...
    <table align="center" width="600" border="0" cellpadding="0" cellspacing="0" style="margin:15px auto;">
      <tr>
        ...
        <td align="right">
        	<h2 style="float:right; text-align:right; margin:25px 0px 5px 10px; color:#666; font-family:Arial, Helvetica, sans-serif; font-size:26px; font-weight:normal; letter-spacing:-1px;">Congelamento Temporário</h2>
        </td>
      </tr>
      <tr>
        <td colspan="2" bgcolor="#FFFFFF">
            ...
            <p>Estamos enviando este aviso para informar que não localizamos o pagamento da sua fatura vencida em <b><?=dateFormat($VENCIMENTO, "d/m/Y")?></b>. Caso tenha qualquer dúvida a respeito dos valores ou queira negociar a sua fatura, por gentileza, nos contate.</p>
            
            <p>Estamos enviando a fatura novamente abaixo e informamos que desde já os serviços prestados encontram-se bloqueados até que seja regularizada a situação.</p>
            
            <p><b>Caso deseje o cancelamento da conta, contate nossos canais de atendimento.</b></p>        
            <p>
            ...
            <p><b>Se você já efetuou o pagamento desta fatura, por favor entrar em contato urgentemente.</b></p>
            
            <p><b style="color:#c00;">Atenção:</b></p>
            <p>
               <li style="padding-bottom:10px;">Caso não realize o pagamento em até 60 dias, <b>os dados de sua conta serão excluídos.</li>
            </p>
            
            <p>Pague em dia e evite transtornos.</p>
