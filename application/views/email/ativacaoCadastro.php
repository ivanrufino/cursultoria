    ...
    <table align="center" id="recursos" width="600" border="0" cellpadding="0" cellspacing="0" style="margin:15px auto;">
      <tr>
        <td>
        	<a href="#">
            	...
            	<img style="float:left; margin:10px 10px 10px 0;" src="<?=site_url()?>assets/img/logo_painel/cursultoria.png" height="50" border="0" />
        	</a>
        </td>
        <td align="right">
      ...
      <tr>
        <td colspan="2" bgcolor="#FFFFFF">
            ...
            <p>Olá <b><?=$NOME_COMPLETO?></b>,</p>
            
            <p>Este e-mail possui todos os dados e configurações que você precisa saber para ativar sua conta na <?=$this->users->nome_chave()?></p>
            <br>
            <p><b><a href="<?=site_url()?>aluno/ativarConta/<?=$codigo?>">Clique aqui</a> para ativar sua conta</b><p>
                    <br>
            ...
            <p>
                <table style=" width:560px; font:12px Arial, Helvetica, sans-serif; color:#fff;" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <th style="width:105px; background:#f3f3f3; color:#333; padding:3px 6px; text-align:left; font-weight:bold;">Usu&aacute;rio:</th>
                    <td style="padding:4px 6px; color:#666;"><?=$EMAIL?></td>
                  </tr>
                  <tr>
                    <th style="width:105px; background:#f3f3f3; color:#333; padding:3px 6px; text-align:left; font-weight:bold;">Senha:</th>
                    <td style="padding:4px 6px; color:#666;">*******</td>
                  </tr>
                </table>
            </p>
      ...
      <tr>
        ...
        <b><a href="#">noreply@cursultoria.com.br</a></b> para continuar recebendo nossas mensagens</p>
            </div>        </td>
      </tr>
    </table>
