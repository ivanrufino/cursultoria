    ...
    <table align="center" width="600" border="0" cellpadding="0" cellspacing="0" style="margin:15px auto;">
      ...
      <tr>
        <td colspan="2" bgcolor="#FFFFFF">
            ...
            <p><b>Não responda este e-mail. Se for necessário, reabra o ticket na Central de Cliente</b></p>        
            <p>
            ...
            <p>
                <table style=" width:560px; font:12px Arial, Helvetica, sans-serif; color:#fff; background:#f3f3f3" border="0">
                  <tr>
                    <th style="background:#ccc; color:#333; padding:3px 6px; text-align:left; font-weight:bold;">Última interação:</th>
                  </tr>
            ...
            <p>
                O boleto no valor total de está disponível no link abaixo:<br /><br />
