    ...
    <table align="center" width="600" border="0" cellpadding="0" cellspacing="0" style="margin:15px auto;">
      ...
      <tr>
        <td colspan="2" bgcolor="#FFFFFF">
            ...
            <p>Há uma nova solicitação de <b>Registro de Domínio</b> no sistema.</p>
            
            <p>Segue abaixo os dados de cadastro junto ao registro do domínio:</p>        
            <p>
                <table style=" width:560px; font:12px Arial, Helvetica, sans-serif; color:#fff;" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <th style="width:105px; background:#f3f3f3; color:#333; padding:3px 6px; text-align:left; font-weight:bold;">Domínio</th>
            ...
            <p><b>Escolha um órgão de registro de sua preferência e aponte para os DNS abaixo:</b></p>
