...
<form id="form_editAutor" name="form_edit" method="post" action="">
    ...
    <input name="CODIGO" type="hidden" class="textfield-text" required="required" value="<?=$autor->CODIGO?>" style="width:300px;" />
    <div class="line" style=" overflow-x:hidden; display:block;">
        ...
        <div class="configCol_right" style="width:270px;">
            <label>
                <input name="DESCRICAO" type="text" class="textfield-text" required="required" value="<?=$autor->DESCRICAO?>" style="width:300px;" />
            </label>
        </div>
    </div>
