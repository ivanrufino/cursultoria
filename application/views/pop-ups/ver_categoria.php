...
<form id="form_editCategoria" name="form_edit" method="post" action="">

    
    <input name="CODIGO" type="hidden" class="textfield-text" required="required" value="<?=$categoria->CODIGO?>" style="width:300px;" />
    <div class="line" style=" overflow-x:hidden; display:block;">
        ...
        <div class="configCol_right" style="width:270px;">
            <label>
                <input name="DESCRICAO" type="text" class="textfield-text" required="required" value="<?=$categoria->DESCRICAO?>" style="width:300px;" />
            </label>
        </div>
    </div>
