...
<div class="easyui-tabs" fit="true" border="false" id="tt">
    ...
    <form id="form_editDocumentos" name="form_add" method="post" action="">
    <div id="tabs-1" style="height:400px; overflow:hidden;"> 
            ...
            <div style=" float:left;">
            	<label style=" float:left; width:450px;">
                    ...
                    <div class="input-append" style="margin-top:5px;">
                       <input id="photoCover" style="width:360px; height:22px;" value="" class="input-large textfield-text" type="text">
        ...
        <div class="line" style=" display:block;">
        	<label style=" float:left; width:70px;">
                Código<br/>
                <input name="CODIGO_ID" type="text" class="textfield-text" value="<?=$xml->CODIGO_ID?>" style="width:60px;" />
            </label>  
            <label style=" float:left; width:310px;">
                	Título<br/>
                	<input name="TITULO" type="text" class="textfield-text" value="<?=$xml->DESCRICAO?>" style="width:300px;" />
                </label>
            
            <label style=" float:left; width:40px;">
                Revisão<br/>
                <input name="REVISAO" type="text" class="textfield-text" value="<?=$xml->REVISAO?>" style="width:40px;" />
            </label>         
        </div>
    ...
    <input type="hidden" name="GRUPO_ACESSO" value="<?=$xml->GRUPO_ACESSO?>" />
    <input type="hidden" name="CODIGO" value="<?=$xml->CODIGO?>" />
    </form>
</div><!-- /.easyui-tabs -->