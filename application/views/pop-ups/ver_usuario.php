...
<form id="form_editUsuarios" name="form_edit" method="post" action="">
    <ul>
        ...
        <div class="configCol_right" style="width:270px;">
        	<label>
            	<div class="btn-group" data-toggle="buttons-radio">  
                  <button style="height:30px;" type="button" data-toggle="button" value="1" class="btn unique <?=($usuario->STATUS == 1)? 'active' : ''?>">
                    Ativo
                  </button>
                  <button style="height:30px;" type="button" data-toggle="button" value="0" class="btn unique <?=($usuario->STATUS == 0)? 'active' : ''?>">
                    Inativo
                  </button>
                </div>            
            </label>
            ...
            <input type="hidden" name="SENHA_ANTIGA" value="<?=$usuario->SENHA?>" />
        </div>
    </div>
    ...
    <div class="line" style=" overflow-x:hidden; display:block;">
        ...
        <div class="configCol_right" style="width:270px;">
        	<label>
                <input name="NOME" type="text" class="textfield-text" value="<?=$usuario->NOME?>" style="width:250px;" />
            </label>
        </div>
    </div>
    ...
    <div class="line" style=" overflow-x:hidden; display:block;">
        ...
        <div class="configCol_right" style="width:270px;">
        	<label>
                <input name="USUARIO" type="text" class="textfield-text" value="<?=$usuario->USUARIO?>" style="width:250px;" />
            </label>
        </div>
    </div>
    ...
    <div class="line" style=" overflow-x:hidden; display:block;">
        ...
        <div class="configCol_right" style="width:270px;">
        	<label>
                <input name="SENHA" type="password" class="textfield-text" value="" style="width:120px;" />
            </label>
    ...
    <div class="line" style=" overflow-x:hidden; display:block;">
        ...
        <div class="configCol_right" style="width:280px; height:auto;">
        	<label><input type="checkbox" name="PERMISSAO" value="admin" <?=($usuario->PERMISSAO == 'admin')? 'checked="checked"' : ''?> style="float:left; margin-right:5px;" /><b style="font:12px Lucida Sans, Arial, sans-serif; font-weight:bold;">Esse usuário é Administrador</b><br />
