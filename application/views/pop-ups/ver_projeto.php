    ...
    <form id="addProjeto" name="form_add" method="post" action="">
        <div id="tabs-1" style="height:400px; overflow:hidden;"> 
            ...
            <fieldset>
                ...
                <input name="CODIGO" type="hidden" class="textfield-text is_required" required="required" readonly=""  value="<?=$projeto->CODIGO?>"  />
                    <label>Projeto
                        <br />
                        <input name="NOME" type="text" class="textfield-text is_required" required="required" value="<?=$projeto->NOME?>" style="width:175px;" />
                    </label>
                    ...
                    <label>Categoria
                        ...
                        <select id="selectCategoria" name="CATEGORIA" class="easyui-combobox" panelHeight="auto" style="width:190px;">
                            ...
                            foreach ($categorias as $cat) { 
                                $selected="";
                                if ($cat->CODIGO ==$projeto->COD_CATEGORIA){
                                     $selected="selected"; 
                                }
                                ?>
                                
                                <option value="<?= $cat->CODIGO ?>" <?=$selected?>><?= $cat->DESCRICAO ?></option>
                            <?php } ?>
