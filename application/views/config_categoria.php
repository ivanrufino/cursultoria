    ...
    <div class="demo" style="float:right;"> 
		<div class="btn-group2">
          <a class="btn dropdown-toggle" data-toggle="dropdown" href="#" style="margin-right:10px;">
            ...
            <a class="btn" rel="categoriaAdd"><i class="ico-plus"></i> Adcionar</a>
         </div>
	...
	<div id="users-contain" class="ui-widget">
        ...
        <?php foreach($categorias as $key =>$categoria):
			...
			?>
                ...
                <td>
                    <b><a rel='verCategoria' data-id="<?=$categoria->CODIGO?>">
                        <?=$categoria->DESCRICAO?>
                    </a></b>
                </td>
                <td >
                        	<?=($categoria->STATUS == 1) ? '<p class="tag_green">Sim</p>': '<p class="tag_red">Não</p>';?>
                        </td>
             </tr>
		<?php endforeach;?>
