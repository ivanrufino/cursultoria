...
<div id="breadcrumb">
	<img src="<?=site_url()?>/assets/images/icons/home3.png" />
...
<div class="table_busca_div" style="margin-bottom:10px;">
    <img src="<?=site_url()?>/assets/images/icons/search.png" class="fl_left" style="margin-top:2px;" />
