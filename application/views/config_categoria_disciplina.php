...
<div class="breadcumb borda5px">
    ...
    <a onClick="getURL('configuracoes/geral');">Painel de Controle</a> &raquo; <b>Categorias</b>
</div>
		...
		<div class="btn-group2">
          <a class="btn dropdown-toggle" data-toggle="dropdown" href="#" style="margin-right:10px;">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
              ...
              <li class="divider"></li>
<!--              <li><a tabindex="-1" rel="deleteCategorias" style="font-size:12px; color:#b54646"><i class="ico-trash"></i> Desativar</a></li>
              <li><a tabindex="-1" rel="ativarCategorias" style="font-size:12px; color:green"><i class="icon-edit"></i> Ativar</a></li>-->
            </ul>
            <a class="btn" rel="categoriaDisciplinaAdd"><i class="ico-plus"></i> Adicionar</a>
         </div>
...
<div id="precosDominios">
    ...
    <div align="center" style="border:1px dotted #ddd; padding:10px; overflow:auto;">
        <div style="font:14px Tahoma, Arial; color:#666; overflow:auto; text-align:center; width:350px;">
            ...
            <b style="float:left; font-weight:normal; margin-top:5px;">
                Ainda não existem <font style="text-transform:lowercase; font-weight:bold;">Categorias</font> no sistema.
            </b>
        </div>
    </div>
    <!-- Caso não exista nenhum registro ************************************************* -->
    <?php }else{?>
    <form class="form_selectCategorias" name="formulario" method="post" action="">
	<div id="users-contain" class="ui-widget">
        ...
        <?php foreach($categorias as $key =>$categoria):
			...
			?>
                <td><input type='checkbox' id='item' name='item[]' value='<?=$categoria->CODIGO?>' /></td>
                
                <td>
                    <b><a rel='verCategoriaDisciplina' data-id="<?=$categoria->CODIGO?>">
                        <?=$categoria->DESCRICAO?>
                    </a></b>
                </td>
...
<!-- pop-up de operações -->
<div id="pop_categoriaDisciplina"></div>
<div id="pop_addCategoriaDisciplina"></div>
