...
<div class="breadcumb borda5px">
    ...
    <a onClick="getURL('configuracoes/geral');">Painel de Controle</a> &raquo; <b>Grupos de Usuários</b>
</div>
		...
		<div class="btn-group2">
          <a class="btn dropdown-toggle" data-toggle="dropdown" href="#" style="font-family:Arial, Helvetica, sans-serif; padding:6px; margin-right:10px; font: 12px Arial, Helvetica, sans-serif; font-weight: bold;">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
              ...
              <li class="divider"></li>
              <li><a tabindex="-1" rel="bt_excluirGrupoUsuario" style="font-size:12px;"><i class="icon-trash"></i> Excluir</a></li>
            </ul>
            <a class="btn" rel="bt_novoGrupoUsuario"><i class="icon-plus"></i> Adicionar</a>
         </div>
		
    </div>
</div>
<div id="precosDominios">
	<?php if($grupos_users == NULL){?>
    ...
    <form id="form_selectCategorias" name="formulario" method="post" action="">
        ...
        <tbody>
        	<?php foreach($grupos_users as $key =>$row):
        		if($key % 2){
            ...
            <td><b><a rel='ver_grupoUsuario' data-id="<?=$row->CODIGO?>"><?=$row->DESCRICAO?></a></b></td>
            <td><?=$row->EMAIL?></td>
...
<!-- pop-up de operações -->
<div id="pop_grupoUsuario"></div>
<div id="pop_addgrupoUser"></div>
