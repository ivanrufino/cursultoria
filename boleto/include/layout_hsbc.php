...
<HTML>
<HEAD>
<TITLE>BOLETO #<?=$fatura->CODIGO?></TITLE>
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><img src="../uploads/logos/<?=$user->CODIGO?>.png" height="50" class="header_logo" /></td>
    <td align="right"><IMG onClick="javascript:window.print()" style="cursor:pointer" SRC="../assets/img/boleto/bt_imprimir.gif"></td>
  </tr>
</table>
